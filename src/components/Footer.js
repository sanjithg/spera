            ...
            <div className="footer_row row">
                ...
                <div className="col-md-3 col-sm-6 footer_about quick">
                    ...
                    <ul className="quick_link">
                        <li><a><i className="fa fa-chevron-right"></i>Building Construction</a></li>
                        <li><a><i className="fa fa-chevron-right"></i>Home Renovation</a></li>
                        <li><a><i className="fa fa-chevron-right"></i>Hardwood Flooring</a></li>
                        <li><a><i className="fa fa-chevron-right"></i>Repairing Of Roof</a></li>
                        <li><a><i className="fa fa-chevron-right"></i>Commercial Construction</a></li>
                        <li><a><i className="fa fa-chevron-right"></i>Concrete Transport</a></li>
                    </ul>
                </div>
                <div className="col-md-3 col-sm-6 footer_about">
                    <h2>CONTACT US</h2>
                    <address>
                        ...
                        <ul className="my_address">
                            <li><a><i className="fa fa-envelope" aria-hidden="true"></i>info@sperainfra.in</a></li>
                            <li><a><i className="fa fa-phone" aria-hidden="true"></i>+91 9494413431</a></li>
                            <li><a><i className="fa fa-map-marker" aria-hidden="true"></i><span>6-2-913/914, 1st Floor, Progressive Towers, Khairatabad, Hyderabad – 500 004 </span></a></li>
                        </ul>
                    </address>
                </div>
            </div>
